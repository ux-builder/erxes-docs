...
![](https://erxes-docs.s3.us-west-2.amazonaws.com/create_plugin_cli.gif)


The example below is a new plugin, created from an example template, placed at the main navigation.

![](https://demo-erxes.s3.amazonaws.com/plugin2.png)
...
![](https://demo-erxes.s3.amazonaws.com/plugin3.png)
