  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links': theme('colors.indigo.950'),
        '--tw-prose-links-hover': theme('colors.indigo.900'),
        '--tw-prose-links-underline': theme('colors.indigo.900 / 0.3'),
        ...
        '--tw-prose-invert-links': theme('colors.indigo.950'),
        '--tw-prose-invert-links-hover': theme('colors.indigo.900'),
        '--tw-prose-invert-links-underline': theme('colors.indigo.900 / 0.3'),
