...
mkdir example
```
2. Navigate to your newly created directory where the new erxes project will be set up. This directory will define the database and erxes plugins to use.
```tsx
cd example
```
