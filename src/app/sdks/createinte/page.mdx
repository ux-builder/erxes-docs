...
![](https://erxes-docs.s3.us-west-2.amazonaws.com/imapInboxIntegration.png)
...
![](https://erxes-docs.s3.us-west-2.amazonaws.com/imapIntegrationForm.png)
...
```
[here is the example](https://github.com/erxes/erxes-community/blob/dev/packages/plugin-imap-api/src/messageBroker.ts)
## Receive data from your desired APIs

[here is the code example](https://github.com/erxes/erxes-community/blob/dev/packages/plugin-imap-api/src/utils.ts)
...
![](https://erxes-docs.s3.us-west-2.amazonaws.com/imapInboxConversationDetail.png)
...
![](https://erxes-docs.s3.us-west-2.amazonaws.com/integration_create_cli.gif)

The example below is a new integration plugin, created from an example template, placed at the settings integration.
![](https://erxes-docs.s3.us-west-2.amazonaws.com/integration_list.png)
...
![](https://erxes-docs.s3.us-west-2.amazonaws.com/integration_config.png)

The example below is a creating new example integration using the form.
![](https://erxes-docs.s3.us-west-2.amazonaws.com/integration_create.gif)
...
![](https://erxes-docs.s3.us-west-2.amazonaws.com/integration_detail_page.gif)
