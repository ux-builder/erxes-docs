...
function InfoIcon0(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg height="2em" viewBox="0 0 16 16" aria-hidden="true" {...props}>
...
export function Tip({ children }: { children: React.ReactNode }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-white-500/20 bg-white-50/50 p-4 leading-6 text-white-950 dark:border-white-500/30 dark:bg-white-500/5 dark:text-white-200 dark:[--tw-prose-links-hover:theme(colors.white.300)] dark:[--tw-prose-links:theme(colors.white)]">
...
function InfoIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg height="8em" viewBox="0 0 19 18" color="black" aria-hidden="true" {...props}>
...
export function Note({ children }: { children: React.ReactNode }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-indigo-500 bg-indigo-100 p-4 leading-6 text-indigo-950 dark:border-violet-500/30 dark:bg-violet-500/5 dark:text-violet-200 dark:[--tw-prose-links-hover:theme(colors.violet.300)] dark:[--tw-prose-links:theme(colors.white)]">
...
function InfoIcon2(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg height="2em" viewBox="0 0 24 24">
...
export function Info({ children }: { children: React.ReactNode }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-sky-500 bg-sky-100 p-4 leading-6 text-blue-950 dark:border-blue-500/30 dark:bg-blue-500/5 dark:text-blue-200 dark:[--tw-prose-links-hover:theme(colors.blue.300)] dark:[--tw-prose-links:theme(colors.blue)]">
...
function InfoIcon3(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg height="2em" viewBox="0 0 510 512">
...
export function Caution({ children }: { children: React.ReactNode }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-amber-500 bg-amber-50 p-4 leading-6 text-amber-950 dark:border-amber-500 dark:bg-amber-50 dark:text-amber-950 dark:[--tw-prose-links-hover:theme(colors.amber.300)] dark:[--tw-prose-links:theme(colors.amber)]">
      <InfoIcon3 className="mt-1 h-4 w-4 flex-none fill-amber-500 stroke-amber dark:fill-amber-100 dark:stroke-amber-200" />
      <div className="[&>:first-child]:mt-0 [&>:last-child]:mb-0">
        {children}
      </div>
    </div>
...
function InfoIcon4(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg height="2em" viewBox="0 0 584 612">
...
export function Danger({ children }: { children: React.ReactNode }) {
  return (
    <div className="my-6 flex gap-2.5 rounded-2xl border border-red-600 bg-red-100 p-4 leading-6 text-zinc-950 dark:border-red-500/30 dark:bg-red-500/5 dark:text-red-200 dark:[--tw-prose-links-hover:theme(colors.red.300)] dark:[--tw-prose-links:theme(colors.red)]">
      <InfoIcon4 className="mt-1 h-4 w-4 flex-none fill-red-950 stroke-red dark:fill-red-200/20 dark:stroke-red-200" />
      <div className="[&>:first-child]:mt-0 [&>:last-child]:mb-0">
        {children}
      </div>
    </div>
