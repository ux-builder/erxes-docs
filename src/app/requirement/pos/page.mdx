...
<TabItem value="functional" label="Functional Requirements">

| Setting name            | Instructions                                                                                    |
|-------------------------|-------------------------------------------------------------------------------------------------|
| User Management         |Secure login for staff with different roles (cashier, manager, admin), User permissions to rest  |

</TabItem>

<TabItem value="non-functional" label="Non-functional Requirements">

| Setting name      | Instructions                                                                                          |
|-------------------|-------------------------------------------------------------------------------------------------------|
| Performance       |The system should handle a minimum of 100 transactions per hour without performance degradation, Respon|
