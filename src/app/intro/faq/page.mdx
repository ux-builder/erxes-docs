...
Please see the [LICENSE](https://github.com/erxes/erxes/blob/master/LICENSE.md) file for licensing information.

# Are these all free? Can we just use it for free?

Yes, we’re open-source software, our license is [AGPLv3](https://github.com/erxes/erxes/blob/master/LICENSE.md) with [Enterprise Edition](https://github.com/erxes/erxes/tree/master/ee), which means some of our plugins and code for SaaS are require prior agmeenent and kept private under Enterpise Edition. But the rest are all free for you to install and use for you. Please read more about our license [here](https://erxes.io/blog/posts/changing-the-license-to-agplv3-with-the-enterprise-edition).
