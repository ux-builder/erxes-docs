...
Thank you for considering contributing to erxes! This document will outline how to submit changes to this repository and which conventions to follow. If you are ever in doubt about anything, we encourage you to reach out by submitting an issue here or via [Discord](https://discord.com/invite/aaGzy3gQK5).
...
1. Before you start working on a change, please make sure there is an issue with what you will be working on. You can either find an [existing issue](https://github.com/erxes/erxes/issues) or [open a new issue](https://github.com/erxes/erxes/issues/new/choose) if none exists. Doing this ensures that others can contribute with thoughts or suggest alternatives, ultimately ensuring that we only add changes that make the most sense for erxes future.
2. When you are ready to start working on a change, you should first [fork the erxes repo](https://docs.github.com/en/get-started/quickstart/fork-a-repo) and [branch out](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-and-deleting-branches-within-your-repository) from the develop branch.
3. Make your changes.
4. [Open a pull request towards the development branch in the erxes repo](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request-from-a-fork). Within a couple of days, erxes team members will review, comment, and eventually approve your PR.
# Workflow
### Branches
