  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links': theme('colors.indigo.800'),
        '--tw-prose-links-hover': theme('colors.indigo.800'),
        '--tw-prose-links-underline': theme('colors.indigo.800 / 0.3'),
        ...
        '--tw-prose-invert-links': theme('colors.indigo.200'),
        '--tw-prose-invert-links-hover': theme('colors.indigo.300'),
        '--tw-prose-invert-links-underline': theme('colors.indigo.200 / 0.3'),
